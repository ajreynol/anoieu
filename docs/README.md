...
| [`bug_db/static-analysis.md`](../bug_db/static-analysis.md) | **the static subset rendered from the database**. Nothing here closes a finding. *Rewritten whole, from the database* |
