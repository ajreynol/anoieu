...
[`experience.md`](../docs/experience.md), because each is a statement about what the language
means.
...
[`experience.md`](../docs/experience.md) -- the register of what anoieu is asking of whom.
...
| **M1** ✅ | resolution, attribute contracts, dead code, docstring lint, `stats` | 30 checks, a witness apiece, and real findings on CPC and on `ethos/tests` -- see [`experience.md`](../docs/experience.md) |
...
of [`experience.md`](../docs/experience.md) is that record, and it is the part of M1 that
...
the [README](../README.md#findings-and-reports), and referenced from there.
