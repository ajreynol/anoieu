...
without someone saying why.
    ...
    python3 -m anoieu_analyzer.reporting.gen_open_findings             # add anything new
    python3 -m anoieu_analyzer.reporting.gen_open_findings --check     # exit 1 if something is unlisted
    python3 -m anoieu_analyzer.reporting.gen_open_findings --roots elsewhere
...
def main() -> int:
    ...
    if args.check:
        ...
        print(
            ...
            "run anoieu_analyzer/reporting/gen_open_findings.py and commit",
            file=sys.stderr,
        )
