...
skipped.
    ...
    python3 -m anoieu_analyzer.reporting.landing             # what is outstanding, from the ledger
    python3 -m anoieu_analyzer.reporting.landing --check     # ... and ask each checkout about it
    python3 -m anoieu_analyzer.reporting.landing --repo ethos=/src/ethos --check

Checkouts come from `anoieu_analyzer/reporting/config/repos.local` -- the same mapping `process_anoieu`
