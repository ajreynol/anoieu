...
as `F5` in [`../zetesis/findings.md`](../zetesis/findings.md), which is where
...
- **It does not grade tools.** What a tool weighs against the tenets is
  [`../stathmos/`](../stathmos/README.md); whether our conduct can be shown is
  [`../martyria/`](../martyria/README.md) and
  [`../zetesis/`](../zetesis/README.md). This is about the accuracy of
