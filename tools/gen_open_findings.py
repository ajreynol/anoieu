...
[`upstream.md`](upstream.md) for what has happened to the findings that were
...
2. **Closing is a separate, deliberate step.** A finding leaves the open table
   ...
   what happened into [`upstream.md`](upstream.md).
...
reasoning belongs in [`upstream.md`](upstream.md); this table is the ledger.
