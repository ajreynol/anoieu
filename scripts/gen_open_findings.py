...
without someone saying why.
    ...
    python3 scripts/gen_open_findings.py             # add anything new
    python3 scripts/gen_open_findings.py --check     # exit 1 if something is unlisted
    python3 scripts/gen_open_findings.py --roots elsewhere
        ...
        for group in signatures(paths, skip):
            ...
            for d in list(result.diagnostics) + run_all(ctx):
                ...
                if os.path.abspath(d.span.path) in skip:
                    continue  # see NOT_AUDITED in scripts/gen_corpus_table.py
...
def main() -> int:
    ...
    if args.check:
        ...
        print(
            ...
            "run scripts/gen_open_findings.py and commit",
            file=sys.stderr,
        )
